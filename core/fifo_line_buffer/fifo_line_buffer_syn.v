...
//scfifo ADD_RAM_OUTPUT_REGISTER="OFF" DEVICE_FAMILY="Cyclone IV E" LPM_NUMWORDS=1024 LPM_SHOWAHEAD="ON" LPM_WIDTH=8 LPM_WIDTHU=10 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" USE_EAB="ON" aclr clock data q rdreq usedw wrreq INTENDED_DEVICE_FAMILY="Cyclone IV E"
...
//a_dpfifo ADD_RAM_OUTPUT_REGISTER="OFF" ALLOW_RWCYCLE_WHEN_FULL="OFF" DEVICE_FAMILY="Cyclone IV E" LPM_NUMWORDS=1024 LPM_SHOWAHEAD="ON" lpm_width=8 lpm_widthu=10 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" aclr clock data q rreq sclr usedw wreq INTENDED_DEVICE_FAMILY="Cyclone IV E"
//VERSION_BEGIN 18.0 cbx_altdpram 2018:04:24:18:04:18:SJ cbx_altera_counter 2018:04:24:18:04:18:SJ cbx_altera_syncram 2018:04:24:18:04:18:SJ cbx_altera_syncram_nd_impl 2018:04:24:18:04:18:SJ cbx_altsyncram 2018:04:24:18:04:18:SJ cbx_cycloneii 2018:04:24:18:04:18:SJ cbx_fifo_common 2018:04:24:18:04:18:SJ cbx_lpm_add_sub 2018:04:24:18:04:18:SJ cbx_lpm_compare 2018:04:24:18:04:18:SJ cbx_lpm_counter 2018:04:24:18:04:18:SJ cbx_lpm_decode 2018:04:24:18:04:18:SJ cbx_lpm_mux 2018:04:24:18:04:18:SJ cbx_mgl 2018:04:24:18:08:49:SJ cbx_nadder 2018:04:24:18:04:18:SJ cbx_scfifo 2018:04:24:18:04:18:SJ cbx_stratix 2018:04:24:18:04:18:SJ cbx_stratixii 2018:04:24:18:04:18:SJ cbx_stratixiii 2018:04:24:18:04:18:SJ cbx_stratixv 2018:04:24:18:04:18:SJ cbx_util_mgl 2018:04:24:18:04:18:SJ  VERSION_END


//altsyncram ADDRESS_ACLR_A="NONE" ADDRESS_ACLR_B="NONE" ADDRESS_REG_B="CLOCK0" DEVICE_FAMILY="Cyclone IV E" ENABLE_ECC="FALSE" INDATA_ACLR_A="NONE" NUMWORDS_A=1024 NUMWORDS_B=1024 OPERATION_MODE="DUAL_PORT" OUTDATA_REG_B="UNREGISTERED" WIDTH_A=8 WIDTH_B=8 WIDTH_BYTEENA_A=1 WIDTH_ECCSTATUS=2 WIDTHAD_A=10 WIDTHAD_B=10 WRCONTROL_ACLR_A="NONE" address_a address_b clock0 data_a q_b wren_a
...
module  fifo_line_buffer_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
endmodule //fifo_line_buffer_altsyncram


//lpm_compare DEVICE_FAMILY="Cyclone IV E" LPM_WIDTH=10 ONE_INPUT_IS_CONSTANT="YES" aeb dataa datab
...
endmodule //fifo_line_buffer_cmpr


//lpm_counter DEVICE_FAMILY="Cyclone IV E" lpm_direction="UP" lpm_port_updown="PORT_UNUSED" lpm_width=9 aclr clock cnt_en q sclr
...
`endif
	...
	assign
		wire_counter_reg_bit_asdata = ({9{(~ sclr)}} & (({9{sset}} & s_val) | ({9{(~ sset)}} & data))),
	...
	assign
		...
		wire_counter_reg_bit_sload = {9{((sclr | sset) | sload)}};
	assign
		aclr_actual = aclr,
		clk_en = 1'b1,
		data = {9{1'b0}},
		...
		sset = 1'b0,
		updown_dir = 1'b1;
endmodule //fifo_line_buffer_cntr
...
`endif
	...
	assign
		...
		sset = 1'b0,
		updown_dir = updown;
endmodule //fifo_line_buffer_cntr1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fifo_line_buffer_cntr12
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		sset = 1'b0,
		updown_dir = 1'b1;
endmodule //fifo_line_buffer_cntr12

//synthesis_resources = lut 29 M9K 1 reg 47 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fifo_line_buffer_a_dpfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	fifo_line_buffer_altsyncram   FIFOram
	( 
	...
	fifo_line_buffer_cmpr   almost_full_comparer
	( 
	.aeb(wire_almost_full_comparer_aeb),
	.dataa({10{1'b1}}),
	.datab(wire_usedw_counter_q));
	fifo_line_buffer_cmpr   three_comparison
	( 
	.aeb(wire_three_comparison_aeb),
	.dataa(wire_usedw_counter_q),
	.datab(10'b0000000011));
	fifo_line_buffer_cntr   rd_ptr_msb
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.q(wire_rd_ptr_msb_q),
	.sclr(sclr));
	fifo_line_buffer_cntr1   usedw_counter
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.sclr(sclr),
	.updown(valid_wreq));
	fifo_line_buffer_cntr12   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
...
endmodule //fifo_line_buffer_a_dpfifo

//synthesis_resources = lut 29 M9K 1 reg 47 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fifo_line_buffer_scfifo
	( 
	aclr,
	clock,
	data,
...
`endif
	...
	fifo_line_buffer_a_dpfifo   dpfifo
	( 
	.aclr(aclr),
	.clock(clock),
	.data(data),
	...
	assign
		...
		sclr = 1'b0,
		usedw = wire_dpfifo_usedw;
endmodule //fifo_line_buffer_scfifo
//VALID FILE
...
module fifo_line_buffer (
	...
	fifo_line_buffer_scfifo	fifo_line_buffer_scfifo_component (
				.aclr (aclr),
				.clock (clock),
				.data (data),
				.rdreq (rdreq),
